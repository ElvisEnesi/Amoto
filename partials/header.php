...
<body>
    <section class="header">
        ...
        <div>
            ...
            ?>
            <a href="<?= root_url ?>admin/dashboard.php"><img src="./images/users/<?= $user['picture'] ?>"></a>
            <a href="<?= root_url ?>admin/cart.php"><ion-icon name="cart-outline"></ion-icon>(<?= $total_active_carts ?>)</a>
            <?php else : ?>
